...
APP_NAME="pictureframe"
USER="root"
GROUP="$USER"
NODE_ENV="production"
PORT="80"
APP_DIR="/home/linaro/pictureframe"
NODE_APP="index.js"
KWARGS=""
CONFIG_DIR="$APP_DIR"
PID_DIR="$APP_DIR/pid"
...
start_it() {
    ...
    echo "cd $APP_DIR && PORT=$PORT NODE_ENV=$NODE_ENV NODE_CONFIG_DIR=$CONFIG_DIR $NODE_EXEC 1>$LOG_FILE 2>&1 & echo \$! > $PID_FILE" | sudo -i -u $USER
